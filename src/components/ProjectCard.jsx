...
function ProjectCard({image, title, description, url}) {
  return (
    <a href={url} className='flex flex-col mx-auto items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row max-w-xl hover:bg-gray-100 mb-5 p-[30px]'>
